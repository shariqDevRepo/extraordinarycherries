...
import communityImg1 from "../assets/images/community-1.png";
import communityImg2 from "../assets/images/community-2.png";
  ...
  return (
    <section className="mb-32 pt-32">
      <div className="mx-auto container px-4 sm:px-12">
        <div className="relative py-14 px-8 lg:px-14 border border-[#0F1134] bg-[#B479FF] rounded-10xl flex flex-col lg:flex-row items-center gap-12">
          <img
            data-aos="zoom-in"
            src={communityImg1}
            alt=""
            className="-mt-16 lg:-mt-32 w-full max-w-[520px] animated-bg"
          />

          <div className="flex-1 flex flex-col items-center lg:items-start">
            <h2
              data-aos="fade-down"
              className="mb-4 font-secondary text-5xl lg:text-6xl text-center lg:text-left uppercase text-white ts-2"
            >
            ...
            <p
              data-aos="zoom-in"
              data-aos-delay="100"
              className="max-w-[500px] lg:text-lg font-medium text-center lg:text-left text-white"
            >
            ...
            <div
              data-aos="zoom-in"
              data-aos-delay="200"
              className="primary-btn-wrapper relative mt-8 w-fit"
            >
              <Link
